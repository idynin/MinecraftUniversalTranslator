...
public class NetHandlerTest {
  ...
  /**
   * Test method for {@link com.idynin.TranslateAPI.net.NetHandler#get(java.util.List)}.
   */
  @Test
  public final void testGetListOfURL() {
    ...
    for (int i = 0; i < urls.size(); i++) {
      assertEquals("testGetListOfURL", "c_" + files.get(i).getName().split("\\_")[0],
          results.get(i));
      files.get(i).delete();
    }
  ...
  /**
   * Test method for {@link com.idynin.TranslateAPI.net.NetHandler#get(java.net.URL)}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.idynin.TranslateAPI.net.NetHandler#getUserAgent()}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.idynin.TranslateAPI.net.NetHandler#NetHandler()}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.idynin.TranslateAPI.net.NetHandler#NetHandler(int)}.
   */
  @Test
