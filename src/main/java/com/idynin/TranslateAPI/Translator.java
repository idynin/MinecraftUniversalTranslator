...
public class Translator {
  ...
  public TranslationQuery queryConstructor(String sourceText, Language sourceLanguage,
      Language targetLanguage) {
    return new TranslationQuery(sourceText, sourceLanguage, targetLanguage);
  }

  public List<TranslationQuery> queryConstructor(String sourceText, Language sourceLanguage,
