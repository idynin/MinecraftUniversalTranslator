...
public class MinecraftUniversalTranslatorEventListener implements Listener {
  ...
  public MinecraftUniversalTranslatorEventListener(MinecraftUniversalTranslator plugin) {
  ...
  public void onChatEvent(final AsyncPlayerChatEvent event) {
    Logger.getLogger("Minecraft").info("Caught Message: " + event.getMessage());
    ...
    new BukkitRunnable() {
      ...
      public void run() {
        ...
        List<TranslationQuery> queryList = tr.queryConstructor(message, sourceLang, targets);
